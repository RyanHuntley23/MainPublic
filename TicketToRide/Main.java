...
public class Main {
    ...
    private static final String MAPFILENAME = "EuropeBoard.txt";
    ...
    private static final int NUMTICKETS = 80;
    ...
    private static final Random RAND = new Random(941102124111114278L);
    ...
    private static final boolean PRINTNUMTICKETS = true;
    ...
    public static void main(String[] args) {
        ...
        if (!(TICKETLISTFILENAME == null)) {
            ...
            b = new Board(MAPFILENAME, TICKETFILENAME);
            ...
            do {
                ...
                b.randomTickets(NUMTICKETS, seed);
                numRuns += 1;
